...
internal sealed class UiLocalization
{
    private static readonly IReadOnlyDictionary<string, string> Italian = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["Devices"] = "Dispositivi",
        ["Profiles"] = "Profili",
        ["Controller profiles"] = "Profili controller",
        ["Macros"] = "Macro",
        ["Mapping"] = "Mappatura",
        ["Mapping + Test"] = "Mappatura + test",
        ...
        ["Mapping editor"] = "Editor mappatura",
        ["Mapping profiles"] = "Profili di mappatura",
        ["Xbox outputs"] = "Output Xbox",
        ["Virtual Xbox controller"] = "Controller Xbox virtuale",
        ["Live controller"] = "Controller in tempo reale",
        ["Connected pads"] = "Controller connessi",
        ...
        ["Duplicate"] = "Duplica",
        ["Delete"] = "Elimina",
        ["Detect input"] = "Rileva input",
        ["Cancel detection"] = "Annulla rilevamento",
        ["Cancel guided mapping"] = "Annulla mappatura guidata",
        ["Recording guided mapping"] = "Mappatura guidata in corso",
        ["Reset defaults"] = "Ripristina predefiniti",
        ["Reload"] = "Ricarica",
        ["Open folder"] = "Apri cartella",
        ["Open logs"] = "Apri log",
        ["Open state"] = "Apri stato",
        ...
        ["Reset all button mappings to the Stadia/Xbox defaults?"] = "Ripristinare tutte le mappature pulsanti ai valori predefiniti Stadia/Xbox?",
        ["Reset the current profile to the Stadia/Xbox defaults?"] = "Ripristinare il profilo corrente ai valori predefiniti Stadia/Xbox?",
        ["This profile has unassigned or conflicting Xbox outputs. Save it anyway?"] = "Questo profilo contiene output Xbox non assegnati o in conflitto. Salvarlo comunque?",
        ["Discard all unsaved mapping changes?"] = "Eliminare tutte le modifiche di mappatura non salvate?",
        ["Save mapping changes before closing?"] = "Salvare le modifiche di mappatura prima di chiudere?",
        ["Guided mapping cancelled"] = "Mappatura guidata annullata",
        ["Guided mapping complete. Save all changes."] = "Mappatura guidata completata. Salva tutte le modifiche.",
        ["Mapping saved and active"] = "Mappatura salvata e attiva",
        ["Saved mapping reloaded"] = "Mappatura salvata ricaricata",
        ["Profile duplicated"] = "Profilo duplicato",
        ["Profile deleted"] = "Profilo eliminato",
        ["At least one mapping profile is required"] = "È necessario almeno un profilo di mappatura",
        ["Profile name cannot be empty"] = "Il nome del profilo non può essere vuoto",
        ["Active profile"] = "Profilo attivo",
        ["Xbox outputs assigned"] = "output Xbox assegnati",
        ["unused Stadia inputs"] = "input Stadia inutilizzati",
        ["Not assigned"] = "Non assegnato",
        ["Missing"] = "Mancante",
        ["Conflict"] = "Conflitto",
        ["Waiting"] = "In attesa",
        ["Waiting for controller"] = "In attesa del controller",
        ["No controller telemetry yet. Start Windows Native and press a button."] = "Nessun dato dal controller. Avvia Windows Native e premi un pulsante.",
        ["No active controller. Press a button."] = "Nessun controller attivo. Premi un pulsante.",
        ["Data not updated"] = "Dati non aggiornati",
        ["Controller telemetry is stale. Last update"] = "Dati controller non aggiornati. Ultimo aggiornamento",
        ...
        ["HID output mode"] = "Modalità output HID",
        ["Changes the vibration output method. Press Vibrate after each change."] = "Cambia il metodo di output della vibrazione. Premi Vibra dopo ogni cambio.",
        ["Press Vibrate after changing HID mode to compare the result."] = "Premi Vibra dopo aver cambiato modalità HID per confrontare il risultato.",
        ["The receiver will use it on the next vibration."] = "Il ricevitore la userà alla prossima vibrazione.",
        ["It will be used the next time Windows Native starts."] = "Sarà usata al prossimo avvio di Windows Native.",
        ["Hardware"] = "Hardware",
        ["Input"] = "Input",
        ["Pressed"] = "Premuti",
        ["Stadia input"] = "Input Stadia",
        ["Xbox output"] = "Output Xbox",
        ["Disabled"] = "Disabilitato",
        ["Capture"] = "Cattura",
        ["D-pad Up"] = "Croce su",
        ["D-pad Down"] = "Croce giù",
        ["D-pad Left"] = "Croce sinistra",
        ["D-pad Right"] = "Croce destra",
        ["Protected"] = "Protetto",
        ...
        ["Select a Stadia controller first."] = "Seleziona prima un controller Stadia.",
        ["Windows has not exposed this controller Bluetooth address yet. Keep it connected and press Check, then try again."] = "Windows non ha ancora esposto l'indirizzo Bluetooth del controller. Lascialo connesso, premi Controlla e riprova.",
