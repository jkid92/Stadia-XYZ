...
The GUI, batch files, configuration file, runtime binaries, and documentation are packaged into a ZIP and a Windows installer EXE by the release workflow.
...
Every push to `main` creates downloadable workflow artifacts. Pushing a tag like `v0.2.0` also creates a GitHub Release with the ZIP and installer EXE attached.
