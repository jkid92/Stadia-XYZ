...
3. Creates `dist/Stadia-X-<version>.zip` and a matching SHA256 file.

Every push to `main` creates downloadable workflow artifacts. Pushing a tag like `v0.2.0` also creates a GitHub Release with the ZIP attached.
